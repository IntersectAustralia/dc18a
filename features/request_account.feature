Feature: Request an account
  ...
  Scenario: Email to superuser upon account request and clicking through to access requests page
    ...
    When I fill in the following:
      ...
      | Last Name        | Bloggs                    |
    And I press "Submit Request"
    Then "diego.alonso@intersect.org.au" should receive an email with subject "DC18A - There has been a new access request"
  ...
  Scenario: Deactivated supers shouldn't get the email
    Given I have a user "fred@intersect.org.au" with role "Administrator"
