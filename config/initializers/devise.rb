...
Devise.setup do |config|
  ...
  config.case_insensitive_keys = [ :email, :user_id ]
  ...
  # enable it only for database (user_id + password) authentication.
  ...
  # config.pepper = "2bed657147cb256cd647356fef5fd17ac79b1171a9b5fc8e19ee907ed3da2f8c8645b3b3af8f19456ad9123e7eb6d8056a31a3d54670f4639246b636b41c8492"
  ...
  config.confirmation_keys = [ :user_id ]
...
config.timeout_in = 30.minutes
  ...
  config.reset_password_keys = [ :user_id ]
